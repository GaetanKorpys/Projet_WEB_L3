...
<main class="flex flex-grow flex-col items-center mx-auto bg-white my-10 p-4 rounded-lg w-1/3 border-2 border-gray-600">
    ...
    <div class="space-y-10">
        ...
        <div>
            ...
            <a href="<?="../Vue/index.php?page=favoris&cocktail="?><?=$id=get_id($cocktail)?>" class="flex mx-auto max-w-min p-2 mt-7 ease-out duration-700 hover:bg-red-300 rounded transform hover:-translate-y-1 hover:scale-110 ring-2 ring-red-200 ring-offset-2 hover:text-black">
                <span>Ajouter</span>
