        ...
        <?php foreach($tab_cocktail_valide as $id=>$cocktail): ?>
            <div class=" w-60 flex flex-col justify-around p-3 m-6 rounded-lg border-2 border-gray-500 bg-white transition duration-300 transform hover:scale-105 hover:border-black">
                <div class="flex justify-evenly">
                    ...
                    <a href="<?="../Vue/index.php?page=favoris&cocktail="?><?=$id=get_id($cocktail)?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="ml-3 h-6 w-6 flex-shrink-0" viewBox="0 0 24 24" fill="<?=in_array($id,$tab_IdCockatil_favoris)?"red":"none"?>" stroke="currentColor" >
